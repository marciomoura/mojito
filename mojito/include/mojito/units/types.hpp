...
template <typename Base> using length_cus_pu_t = quantity<length_dim, per_unit<Base>>;
template <typename Base> using mass_cus_pu_t = quantity<mass_dim, per_unit<Base>>;
template <typename Base> using duration_cus_pu_t = quantity<time_dim, per_unit<Base>>;
template <typename Base> using speed_cus_pu_t = quantity<speed_dim, per_unit<Base>>;
template <typename Base> using acceleration_cus_pu_t = quantity<acceleration_dim, per_unit<Base>>;
template <typename Base> using frequency_cus_pu_t = quantity<frequency_dim, per_unit<Base>>;
template <typename Base> using angular_frequency_cus_pu_t = quantity<frequency_dim, per_unit<Base>>;
template <typename Base> using force_cus_pu_t = quantity<force_dim, per_unit<Base>>;
template <typename Base> using torque_cus_pu_t = quantity<torque_dim, per_unit<Base>>;
template <typename Base> using moment_of_inertia_cus_pu_t = quantity<moment_of_inertia_dim, per_unit<Base>>;
template <typename Base> using voltage_cus_pu_t = quantity<voltage_dim, per_unit<Base>>;
template <typename Base> using current_cus_pu_t = quantity<current_dim, per_unit<Base>>;
template <typename Base> using power_cus_pu_t = quantity<power_dim, per_unit<Base>>;
template <typename Base> using resistance_cus_pu_t = quantity<resistance_dim, per_unit<Base>>;
template <typename Base> using impedance_cus_pu_t = quantity<resistance_dim, per_unit<Base>>;
template <typename Base> using capacitance_cus_pu_t = quantity<capacitance_dim, per_unit<Base>>;
template <typename Base> using inductance_cus_pu_t = quantity<inductance_dim, per_unit<Base>>;
template <typename Base> using flux_cus_pu_t = quantity<magnetic_flux_dim, per_unit<Base>>;
template <typename Base> using magnetic_field_strength_cus_pu_t = quantity<mag_field_strength_dim, per_unit<Base>>;
template <typename Base> using flux_density_cus_pu_t = quantity<flux_density_dim, per_unit<Base>>;
template <typename Base> using angle_cus_pu_t = quantity<dimensionless_dim, per_unit<Base>>;
template <typename Base> using damping_coefficient_cus_pu_t = quantity<dimensionless_dim, per_unit<Base>>;
template <typename Base> using inertia_constant_cus_pu_t = quantity<time_dim, per_unit<Base>>;
