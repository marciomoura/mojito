...
using ::mojito::angular_frequency_custom_pu_t;
using ::mojito::force_custom_pu_t;
using ::mojito::torque_custom_pu_t;
using ::mojito::moment_of_inertia_custom_pu_t;
using ::mojito::voltage_custom_pu_t;
using ::mojito::current_custom_pu_t;
using ::mojito::power_custom_pu_t;
using ::mojito::resistance_custom_pu_t;
using ::mojito::impedance_custom_pu_t;
using ::mojito::capacitance_custom_pu_t;
using ::mojito::inductance_custom_pu_t;
using ::mojito::flux_custom_pu_t;
using ::mojito::magnetic_field_strength_custom_pu_t;
using ::mojito::flux_density_custom_pu_t;
using ::mojito::angle_custom_pu_t;
using ::mojito::damping_coefficient_custom_pu_t;
using ::mojito::inertia_constant_custom_pu_t;
